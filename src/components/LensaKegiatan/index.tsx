...
export default function LensaKegiatan() {
  return (
    <section id="lensa-kegiatan">
      ...
      <div id="lensa-kegiatan__categories" className="mb-4">
        <Swiper
          ...
          slidesPerView="auto"
          spaceBetween={8}
          id="lensa-kegiatan__categories__slider"
          className="!py-4"
        >
      ...
      <div id="lensa-kegiatan__items" className="!-m-4">
        <Swiper
